...
the subitizing classification task is described in section \ref{readout}. Subitizing performance is reported in section \ref{readout}. Finally, section \ref{qualitative-analysis} highlights measurements of the final models robustness to changes in visual features.\\ \\
...
\begin{figure}
\centering
\includegraphics[height=6.0cm]{bezier.pdf}
...
less improvement (Fig. \ref{fg:dfc_comp}). Although \citet{hou2017deep} show a successful
