...
\begin{titlepage}
    \begin{center}
        ...
        \Large
        \vspace{0.5cm}
        \textit{A bachelor thesis submitted to the University of Amsterdam,\\ 
          presented for a bachelor's degree in Artificial Intelligence}}
        ...
        10801944 \\ \\
        \vspace*{10pt}
        \textbf{Tom Runia (Supervisor)} \\ PhD student in Computer Vision and Machine Learning \\ University of Amsterdam \\ Science Park 904, 1098 XH Amsterdam \\
        \vspace*{50pt}
        18 EC Thesis
        \vfill
        ...
        \includegraphics[width=0.6\textwidth]{uva} \\
        \today
...
\onecolumn % table of contents stuff
{
  ...
  Special thanks to Tom Runia, my bachelor thesis supervisor, for assisting me throughout this project and providing me with the necessary computing facilities. Furthermore, I want to thank the UvA RoboLab for granting me access to their prototyping machine. Finally, the Lisa Cluster provided me with all the computing power one could ever need, bringing peace of mind whenever I was worried I was using other's resources. 
