...
lower losses. 
% Tom: move parameters (maybe more?)
...
\begin{figure}
\centering
%% \includegraphics[height=7cm]{bezier.pdf}
...
\subsection{Hidden Representation Classifier}\label{readout}}
 ...
 % "Training setup"? Mention something about data augmentation here as well?
